...
namespace WarriorBundle1{ //MODIFY
    [InitializeOnLoad]
    public class ReviewWindowEditor : EditorWindow{
		...
		private static string imagePath = "/Resources/Warrior-Pack-Bundle-1-Review.jpg"; //MODIFY
        ...
        [MenuItem("Window/Warrior Pack Bundle 1/Review")] //MODIFY
        static void Init(){
        ...
        void OnGUI(){		
            ...
            if (GUILayout.Button("Rate now!")){
				UnityEditorInternal.AssetStore.Open("content/35924"); //MODIFY
                DisableRating();
            }
